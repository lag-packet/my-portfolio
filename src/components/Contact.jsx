...
const socials = [
  ...
  ...(personal.twitter ? [{ label: 'Twitter', href: personal.twitter, icon: TwitterIcon }] : []),
]
...
export default function Contact() {
  ...
  return (
    <section id="contact" className={styles.contact} ref={ref} aria-labelledby="contact-heading">
      <div className={styles.inner}>
        ...
        >
          ...
          <a
            ...
            aria-label={`Send an email to ${personal.email}`}
          >
            {personal.email}
          </a>
